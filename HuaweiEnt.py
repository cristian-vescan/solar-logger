...
_register_map =  {
    ...
    'State1':     {'addr': '32000', 'registers': 1,  'name': 'Standalone teleindication',        'scale': 1,    'type': 'Bit16','units': ''    , 'use': 'stat',  'method': 'hold'},  
    'State2':     {'addr': '32002', 'registers': 1,  'name': 'Operating status',                 'scale': 1,    'type': 'Bit16','units': ''    , 'use': 'stat',  'method': 'hold'},  
    ...
    'Temp':       {'addr': '32087', 'registers': 1,  'name': 'Cabinet temperature',              'scale': 10,   'type': 'I16',  'units': '°C'  , 'use': 'data',  'method': 'hold'},  
